TERMUX_PKG_HOMEPAGE=https://github.com/novaterm-org/nvterm-core
TERMUX_PKG_DESCRIPTION="NovaTerm core utilities and libraries"
TERMUX_PKG_LICENSE="MIT"
TERMUX_PKG_MAINTAINER="@novaterm"
TERMUX_PKG_VERSION=0.4.0
TERMUX_PKG_REVISION=1
# Builds from the same termux-core source but with com.nvterm paths baked in.
# The source is MIT licensed and fully open source.
...
TERMUX_APP__SHELL_API__SHELL_API_ACTIVITY__CLASS_NAME=${TERMUX_APP__SHELL_API_ACTIVITY__CLASS_NAME} \
TERMUX_APP__SHELL_API__SHELL_API_SERVICE__CLASS_NAME=${TERMUX_APP__SHELL_API_SERVICE__CLASS_NAME} \
